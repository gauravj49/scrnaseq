...
adata = sc.read_10x_h5('input/manec/tissue/stomach1001_mouse_filtered_feature_bc_matrix.h5')
...
# Total number of cells: 904
# Number of cells after min count filter: 904
# Number of cells after max count filter: 904
# Number of cells after MT filter  : 870
# Number of cells after Ribo filter: 781
# Number of cells after gene filter: 781
# Total number of genes: 55488
# Number of genes after minCellsPergene filter: 17871
# Number of highly variable genes: 4640
...
# # To exclude
#  0 = Endothelial_Epithelial_Igfbp3pos
#  4 = Macrophages
#  5 = Fibroblasts
#  8 = Erythrocytes
...
# Add new categories
adata.obs['cellType'].cat.add_categories(['Endothelial_Epithelial_Igfbp3pos','Cluster1','Tumor2','Tumor3','Macrophages','Fibroblasts','Tumor6','Cluster7','Erythrocytes','Cluster9','Cluster10'], inplace=True) 

adata.obs['cellType'].loc[adata.obs['cellType' ]=='0' ]  = 'Endothelial_Epithelial_Igfbp3pos'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='1' ]  = 'Cluster1'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='2' ]  = 'Tumor2'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='3' ]  = 'Tumor3'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='4' ]  = 'Macrophages'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='5' ]  = 'Fibroblasts'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='6' ]  = 'Tumor6'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='7' ]  = 'Cluster7'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='8' ]  = 'Erythrocytes'
...
# Add new categories
adataSubGroup.obs['subCellType'].cat.add_categories(['C0_SubCluster0','C1_Tumor1','C2_Tumor2','C3_SubCluster3','C4_Tumor4','C5_Dendritic','C6_SubCluster6','C7_Macrophages'], inplace=True) 
# Get a new subcluster column
# 0 = 'C0_SubCluster0'
# 1 = 'C1_Tumor1'
# 2 = 'C2_Tumor2'
...
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='1']  = 'C1_Tumor1'
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='2']  = 'C2_Tumor2'
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='3']  = 'C3_SubCluster3'
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='4']  = 'C4_Tumor4'
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='5']  = 'C5_Dendritic'
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='6']  = 'C6_SubCluster6'
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='7']  = 'C7_Macrophages'
