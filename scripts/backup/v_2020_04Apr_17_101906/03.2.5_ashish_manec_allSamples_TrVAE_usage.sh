...
# Running Scanpy 1.4.5.1, on 2020-04-16 23:32.
...
# Number of genes after cell filter: 11022
...
# Highly variable genes intersection: 992
...
for k in marker_genes_cellTypes.keys():
  print(k)
