...
# do 
#  cp -rv /media/rad/HDD2/temp_manec/02StomachBaseline/${d}/outs/filtered_feature_bc_matrix.h5 /home/rad/users/gaurav/projects/seqAnalysis/scrnaseq/input/manec/stomachBaseline/${d}_filtered_feature_bc_matrix.h5; 
# done;
...
projName        = "stomachBaseline_trvae"
