...
class Process(object):
  ...
  Email  : <yhcao@ibms.pumc.edu.cn>
    ...
    def run_cmd(self,args):
        ...
        for o in outs:
            print(o)
        # Convert the list of list as dataframe and save it in an output file
        scsaAnnDF = pd.DataFrame(outs, columns=["Cluster","Type","Celltype","Score","Times"])
        scsaAnnOF = "{0}_SCSA_Annotation.txt".format(get_file_info(args.output)[3])
        scsaAnnDF.to_csv(scsaAnnOF, index=False, sep="\t")
        pass
