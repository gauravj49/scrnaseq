...
projName        = "stomachBaseline_mitGFP_trvae"
...
tissueFilenames = [
                    'input/manec/stomachBaseline/3520_Antrum_filtered_feature_bc_matrix.h5',
                    'input/manec/stomachBaseline/3520_Corpus_filtered_feature_bc_matrix.h5',
...
# - Total number of cells                       : 6441
# - Number of cells after min count filter      : 6135
# - Number of cells after max count filter      : 6237
# - Number of cells after MT filter             : 4433
# - Number of cells after Ribo filter           : 4415
# - Number of cells after gene filter           : 4415

# - Total number of genes                       : 55488
# - Number of genes after minCellsPergene filter: 20999

# - Unfiltered rawqcadata shape                 : (6441, 55488)
# - Filtered rawqcadata shape                   : (4415, 20999)
...
# # 8.2.5) For custom sanger vector and GFP list
sangfp_marker_file     = '/home/rad/users/gaurav/projects/seqAnalysis/scrnaseq/docs/sanger_gfp_marker_list_V1.txt'
sangfp_marker_genes        = import_marker_genes_list(sangfp_marker_file)
# Generate the UMAPs/TSNE for each marker categories
...
sc.pl.umap(adata, color=['sampleID','Ghrl', 'GFP','Myc', 'humanMyc','Gap','IRES','humanCd2'], use_raw=False, color_map=mymap, size=50, legend_loc='on data', edgecolor='k', linewidth=0.05, alpha=0.9)
sc.pl.umap(adata, color=['sampleID','Ghrl', 'GFP','Myc','humanMyc','Gap','IRES','humanCd2'], use_raw=False, color_map=mymap, size=50, edgecolor='k', linewidth=0.05, alpha=0.9,projection='3d')
sc.pl.tsne(adata, color=['sampleID','Ghrl', 'GFP','Myc','humanMyc','Gap','IRES','humanCd2'], use_raw=False, color_map=mymap, size=50, edgecolor='k', linewidth=0.05, alpha=0.9)
