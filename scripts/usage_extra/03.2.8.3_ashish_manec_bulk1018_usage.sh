...
adata = sc.read_10x_h5('input/manec/tissue/bulk1018_mouse_filtered_feature_bc_matrix.h5')
...
# Number of cells after max count filter: 897
# Number of cells after MT filter  : 819
# Number of cells after Ribo filter: 673
# Number of cells after gene filter: 673
# Total number of genes: 55488
# Number of genes after minCellsPergene filter: 17263
# Number of highly variable genes: 4157
...
# # To exclude
#  6 = Endothelial_Epithelial_Igfbp3pos_Fibroblasts
#  4 = Erythrocytes
#  3 = Macrophages
...
# Add new categories
adata.obs['cellType'].cat.add_categories(['Tumor0','Tumor1','Tumor2','Macrophages','Erythrocytes','Tumor5','Endothelial_Epithelial_Igfbp3pos_Fibroblasts'], inplace=True) 
...
adata.obs['cellType'].loc[adata.obs['cellType' ]=='3' ]  = 'Macrophages'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='4' ]  = 'Erythrocytes'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='5' ]  = 'Tumor5'
adata.obs['cellType'].loc[adata.obs['cellType' ]=='6' ]  = 'Endothelial_Epithelial_Igfbp3pos_Fibroblasts'
...
#  4 = Erythrocytes
#  3 = Macrophages
adataSubGroup = adata[~((adata.obs['cellType']=='Endothelial_Epithelial_Igfbp3pos_Fibroblasts') | (adata.obs['cellType']=='Erythrocytes') |(adata.obs['cellType']=='Macrophages'))].copy()
...
# Add new categories
adataSubGroup.obs['subCellType'].cat.add_categories(['C0_Erythrocytes','C1_SubCluster1','C2_Tumor2','C3_Tumor3','C4_Tumor4','C5_Tumor5'], inplace=True) 
# Get a new subcluster column
# 0 = 'Erythrocytes'
# 1 = 'SubCluster1'
# 2 = 'Tumor2'
...
# 4 = 'Tumor4'
# 5 = 'Tumor5'
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='0']  = 'C0_Erythrocytes'
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='1']  = 'C1_SubCluster1'
...
adataSubGroup.obs['subCellType'].loc[adataSubGroup.obs['subCellType' ]=='5']  = 'C5_Tumor5'
