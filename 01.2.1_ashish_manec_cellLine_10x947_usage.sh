...
minGenesPerCell = 1000
minCountPerCell = 1000
maxCountPerCell = 120000
minCellsPergene = 100
mtGenesFilter   = 0.25
rbGenesFilter   = 0.35
bname           = projName
...
# Memory usage: current 1.15 GB, difference +0.13 GB
# Running Scanpy 1.4.5.1, on 2020-04-26 21:07.
...
adata = sc.read_10x_h5('input/manec/cellLine/10x947_filtered_feature_bc_matrix.h5')
...
plt.savefig("{0}/01_raw_{1}_nCounts_nGenes_plot.png".format(plotsDir, bname) , bbox_inches='tight', dpi=175); plt.close('all')
t2 = sc.pl.violin(adata, ['mt_frac','rb_frac'], jitter=0.4, size=2, log=False, cut=0, show=False)
plt.savefig("{0}/01_raw_{1}_MtRbFrac_plot.png".format(plotsDir, bname) , bbox_inches='tight', dpi=175); plt.close('all')
...
# Total number of cells: 6398
# Number of cells after min count filter: 6322
# Number of cells after max count filter: 6316
# Number of cells after MT filter  : 6098
# Number of cells after Ribo filter: 6081
# Trying to set attribute `.obs` of view, copying.
# Number of cells after gene filter: 5982
# Total number of genes: 31053
# Number of genes after minCellsPergene filter: 12031
